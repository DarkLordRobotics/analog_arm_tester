...
// twist & base servos are HiTec HS-7950MH hi-torque geared
// elbow & wrist servos are HiTec HS-5685MH hi-torque geared
// gripper is HiTec HS-422 (update to higher torque?)
////////////////////////////////////////////////////////////////////////////////
#define version "200421_0640"
...
// read PB and potentiometers
  ...
  if (read_PB_save == 1) {
    ...
    for (int i = 0; i < sampleIndex; i++) { // to cover max move range
      Serial.println();
      Serial.print("*** Saved Servo SampleSet: ");
      Serial.println(i);
